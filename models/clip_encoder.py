...
class CLIPTextEncoder(nn.Module):
    ...
    def __init__(self, model_name="/home/ma-user/.cache/huggingface/hub/models--openai--clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41"):
        super().__init__()

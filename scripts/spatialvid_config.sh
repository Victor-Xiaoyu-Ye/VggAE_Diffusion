...
SPATIALVID_ROOT="/cache/dataset/spatial-vid-hq-oft"
...
STREAMVGGT_CKPT="/cache/yexiaoyu/ckpt/streamvggt/checkpoints.pth"

# All generated splits, checkpoints, previews, and reports are kept here.
RUN_ROOT="/cache/yexiaoyu/vggae-runs"
...
I0_PATH="/cache/yexiaoyu/reference.png"

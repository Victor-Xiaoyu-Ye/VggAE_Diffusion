...
SCALE_MIRROR_ROOT="${MIRROR_RUN_ROOT}/scale"
...
SCALE_GEOMETRY_AE_MIRROR_CKPT_URL="${SCALE_GEOMETRY_AE_MIRROR_CKPT_URL:-${SCALE_MIRROR_ROOT}/geometry_autoencoder/checkpoint_latest.pt}"
SCALE_I0_DECODER_MIRROR_CKPT_URL="${SCALE_I0_DECODER_MIRROR_CKPT_URL:-${SCALE_MIRROR_ROOT}/i0_decoder/checkpoint_latest.pt}"
SCALE_DIFFUSION_MIRROR_CKPT_URL="${SCALE_DIFFUSION_MIRROR_CKPT_URL:-${SCALE_MIRROR_ROOT}/compact_dit/checkpoint_latest.pt}"

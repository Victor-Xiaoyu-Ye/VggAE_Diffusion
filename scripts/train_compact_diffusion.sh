...
CUDA_VISIBLE_DEVICES=${GPU_IDS} torchrun --nproc_per_node=${NUM_GPUS} --master_port=29512 \
  ${PROJECT}/train_compact_diffusion.py \
    ...
    --resume ${PROJECT}/ckpts/diffusion_compact/exp-1/checkpoint_epoch0003.pt

#!/bin/bash
# Stage37 control: replace the shifted logit-normal time law with unwarped U(0,1).
set -euo pipefail
...
export WINDOW_NAMESPACE="${WINDOW_NAMESPACE:-r7_window_t2v2_legacy_memory64_uniform_v1}"
export MEMORIZE_CLIPS=64 AUX_LAYER=0 AUX_WEIGHT=0
export TIME_DISTRIBUTION=uniform TIME_SHIFT=1

...
def main():
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("Compact latent caching requires CUDA")
    ...
    encoder, tokenizer = load_models(args, device)
    ...
    try:
        with torch.inference_mode():
            for batch in progress:
                ...
                video_tokens = strip_special_tokens(video_tokens, video_psi)

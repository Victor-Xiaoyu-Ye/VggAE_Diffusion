...
def checkpoint_payload(app_cnn, decoder, ema, optimizer, scheduler,
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            # Call the DDP wrappers so gradients are synchronized across ranks.
